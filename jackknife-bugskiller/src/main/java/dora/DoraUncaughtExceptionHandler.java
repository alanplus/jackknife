...
class DoraUncaughtExceptionHandler implements Thread.UncaughtExceptionHandler {
    ...
    private static dora.DoraUncaughtExceptionHandler sInstance
            = new dora.DoraUncaughtExceptionHandler();//用户自定义的异常处理类

    private DoraUncaughtExceptionHandler() {
    }

    static dora.DoraUncaughtExceptionHandler getInstance() {
        return sInstance;
    }
