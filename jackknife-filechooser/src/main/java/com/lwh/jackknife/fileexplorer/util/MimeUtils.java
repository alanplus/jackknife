...
package com.lwh.jackknife.fileexplorer.util;
...
public final class MimeUtils {
    private static final Map<String, String> sMimetypeExtensionMap = new HashMap();
    private static final Map<String, String> sExtensionMimetypeMap = new HashMap();

    private static void add(String mimeType, String extension) {
        if (!sMimetypeExtensionMap.containsKey(mimeType)) {
            sMimetypeExtensionMap.put(mimeType, extension);
        }

        sExtensionMimetypeMap.put(extension, mimeType);
    }
    ...
    public static boolean hasMimetype(String mimeType) {
        return mimeType != null && !mimeType.isEmpty() ? sMimetypeExtensionMap.containsKey(mimeType) : false;
    }

    public static String guessMimetypeFromExtension(String extension) {
        return extension != null && !extension.isEmpty() ? (String)sExtensionMimetypeMap.get(extension) : null;
    }

    public static boolean hasExtension(String extension) {
        return extension != null && !extension.isEmpty() ? sExtensionMimetypeMap.containsKey(extension) : false;
    }

    public static String guessExtensionFromMimetype(String mimetype) {
        return mimetype != null && !mimetype.isEmpty() ? (String)sMimetypeExtensionMap.get(mimetype) : null;
    }

    public static String getMimetype(File file) {
        return guessMimetypeFromExtension(file.getName().substring(file.getName().lastIndexOf(".") + 1, file.getName().length()).toLowerCase(Locale.CHINA));
    }
