...
================================
![avatar](https://jackknife.oss-cn-hangzhou.aliyuncs.com/jackknife_banner.jpg?Expires=1567148625&OSSAccessKeyId=TMP.hVZg6moewHTYbX6wN55pWXWXK88XSZ7auCZk2kLcvkV3YcLLj5RaFuhqFAQajs8xYrQVTRczrRNRGteyzUghaphapkCBDQAcUjCgATLY47TecEQM2xZKibsAyaWSVh.tmp&Signature=ppxc3tAzAG6FuqJDQqufXGlGuvs%3D)
...
<blockquote>
dependencies {
    <h3>implementation 'com.github.JackWHLiu.jackknife:jackknife-xskin:4.6.5'//一键换肤</h3>
    <h3>implementation 'com.github.JackWHLiu.jackknife:jackknife-xpermission:4.6.5'//动态权限申请</h3>
    <h3>implementation 'com.github.JackWHLiu.jackknife:jackknife-orm:4.6.5'    //android系统数据库操作框架</h3>
    <h3>implementation 'com.github.JackWHLiu.jackknife:jackknife-util:4.6.5'//开发工具类</h3>
    <h3>implementation 'com.github.JackWHLiu.jackknife:jackknife-widget:4.6.5' //自定义控件，各种UI效果</h3>
    <h3>implementation 'com.github.JackWHLiu.jackknife:jackknife-multiproxy:4.6.5' //多渠道开发框架</h3>
    <h3>implementation 'com.github.JackWHLiu.jackknife:jackknife-av:4.6.5' //音视频开发工具</h3>
    <h3>implementation 'com.github.JackWHLiu.jackknife:jackknife-filechooser:4.6.5'//文件和文件夹路径选择器</h3>
    <h3>implementation 'com.github.JackWHLiu.jackknife:jackknife-filepatch:4.6.5'//文件补丁差分合并工具（用于增量更新）</h3>
    <h3>implementation 'com.github.JackWHLiu.jackknife:jackknife-viewinject:4.6.5' //运行期注解的butterknife</h3>
    <h3>implementation 'com.github.JackWHLiu.jackknife:jackknife-viewinject-annotations:4.6.5' //viewinject的扩展包，要基于viewinject</h3>
    <h3>implementation 'com.github.JackWHLiu.jackknife:jackknife-mvp:4.6.5'    //mvp设计理念</h3>
}
</blockquote>
