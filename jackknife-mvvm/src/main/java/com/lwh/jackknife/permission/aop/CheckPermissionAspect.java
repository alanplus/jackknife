...
import com.lwh.jackknife.permission.annotation.CheckPermission;
...
public class CheckPermissionAspect {
    ...
    @Pointcut("execution(@com.lwh.jackknife.permission.annotation.CheckPermission * *(..)) && @annotation(permission)")
