...
public class ActivityHandler extends Context {

    public ActivityHandler(ProcessingEnvironment env, Filer filer) {
        super(env, filer);
    }
    ...
    protected MethodSpec bindView(InjectInfo info, List<? extends Element> elements) {
        ...
        for (int i=0;i<elements.size();i++) {
            ...
            if (viewInject != null) {
                ...
                bindView.addCode("  activity." + e + " = ($T) activity.findViewById(" + id + ");\n", te);
            }
        }
