...
public class BookReaderView extends View {
    ...
    private Path mPath0;
    private Path mPath1;
    Bitmap mCurrentPageBitmap = null; // 当前页
    ...
    boolean mBottomLeftOrTopRight; // 是否属于右上左下
    ...
    public BookReaderView(Context context, int width, int height) {
        super(context);
        mPath0 = new Path();
        mPath1 = new Path();
        mScreenWidth = width;
    ...
    public void calcCornerXY(float x, float y) {
        ...
        if ((mCornerX == 0 && mCornerY == mScreenHeight)
            ...
            mBottomLeftOrTopRight = true;
        else
            mBottomLeftOrTopRight = false;
    }
    ...
    private void drawNextPageAreaAndShadow(Canvas canvas, Bitmap bitmap) {
        ...
        if (mBottomLeftOrTopRight) {  //左下及右上
    ...
    public void loadPage(Bitmap current, Bitmap next) {
        mCurrentPageBitmap = current;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        calcPoints();
        drawCurrentPageArea(canvas, mCurrentPageBitmap, mPath0);
        drawNextPageAreaAndShadow(canvas, mNextPageBitmap);
        drawCurrentPageShadow(canvas);
        drawCurrentBackArea(canvas, mCurrentPageBitmap);
    }
