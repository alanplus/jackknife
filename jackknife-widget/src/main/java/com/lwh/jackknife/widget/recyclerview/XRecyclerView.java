...
import com.lwh.jackknife.widget.recyclerview.swipe.SwipeRefreshLayout;
...
public class XRecyclerView extends FrameLayout {
    ...
    protected void initAttrs(AttributeSet attrs) {
        ...
        try {
            ...
            mScrollbar = a.getInteger(R.styleable.XRecyclerView_scrollbars, -1);
    ...
    public void setAdapter(RecyclerView.Adapter adapter) {
        ...
        adapter.registerAdapterDataObserver(new XRecyclerViewDataObserver(this));
        showRecycler();
    }
