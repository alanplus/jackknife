...
public class EmptyLinearLayout extends LinearLayout implements IEmptyView {
    ...
    public EmptyLinearLayout(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public EmptyLinearLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
