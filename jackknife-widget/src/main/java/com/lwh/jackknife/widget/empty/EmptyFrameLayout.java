...
public class EmptyFrameLayout extends FrameLayout implements IEmptyView {
    ...
    public EmptyFrameLayout(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public EmptyFrameLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
