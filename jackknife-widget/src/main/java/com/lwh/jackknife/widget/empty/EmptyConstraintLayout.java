...
public class EmptyConstraintLayout extends ConstraintLayout implements IEmptyView {

    private View mEmptyView;
    private boolean mEmpty;
    private OnEmptyChangeListener mOnEmptyChangeListener;

    public EmptyConstraintLayout(Context context) {
        this(context, null);
    }

    public EmptyConstraintLayout(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public EmptyConstraintLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
