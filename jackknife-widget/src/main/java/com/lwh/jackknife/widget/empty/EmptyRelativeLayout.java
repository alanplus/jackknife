...
public class EmptyRelativeLayout extends RelativeLayout implements IEmptyView {
    ...
    public EmptyRelativeLayout(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public EmptyRelativeLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
