...
public class EmptyWebView extends WebView implements IEmptyView {
    ...
    public EmptyWebView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public EmptyWebView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
